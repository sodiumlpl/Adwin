function val = current_supply_1_part2(t)

% Load current interpolation

load C:\Users\BEC\Documents\MATLAB\13_Adwin\sequence_manager\+Adwin\+Functions\current_supply_1_part2.mat

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Define position vs time for tanh
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% L = evalin('base','trspt_length_part2'); % Length of the transport
% 
% d = evalin('base','trspt_shape'); % Optimised value : minimize the maximum acceleration
% 
% MagTrap_current = evalin('base','MagTrap_current'); % Initial value of the current in the magnetic coils
% 
% MagTrap_ref = evalin('base','MagTrap_ref'); % Reference value of the current in the magnetic coils
% 
...
% 
% val = MagTrap_current/MagTrap_ref*ppval(pp1,y_pos(t));
% 
% clear pp1 ypos
