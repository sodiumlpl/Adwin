...
%                             ',''Style''               ,''text''', ...
%                             ',''String''              ,num2str(obj.dig_out_struct(i).timings_array(j).out)', ...
%                             ',''Units''               ,Adwin.Default_parameters.Text_Units', ...
...
%                             ');']);
                        eval(['obj.bsg.text',num2str(i),'_',num2str(j),' = uicontrol(', ...
                            '''Parent''               ,obj.bsg.hsp2_',num2str(i),'_',num2str(j), ...
                            ',''Style''               ,''text''', ...
                            ',''String''              ,num2str(obj.dig_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res)', ...
                            ',''Units''               ,Adwin.Default_parameters.Text_Units', ...
                            ',''Position''            ,[0.05 0.05 0.95 0.8]',  ...
                            ',''ButtonDownFcn''       ,@obj.blk_edit_btd_fcn', ...
                            ',''Tag''                 ,','''tag_',num2str(i),'_',num2str(j),'''', ...
...
%                            ',''Style''               ,''text''', ...
%                            ',''String''              ,num2str(obj.ana_out_struct(i).timings_array(j).out)', ...
%                            ',''Units''               ,Adwin.Default_parameters.Text_Units', ...
%                            ',''Position''            ,[c_ofs r_ofs c_wth r_wth]',  ...
...
%                            ');']);
                        eval(['obj.asg.text3',num2str(i),'_',num2str(j),' = uicontrol(', ...
                            '''Parent''               ,obj.asg.hsp3_',num2str(i),'_',num2str(j), ...
                            ',''Style''               ,''text''', ...
                            ',''String''              ,num2str(obj.ana_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res)', ...
                            ',''Units''               ,Adwin.Default_parameters.Text_Units', ...
                            ',''Position''            ,[c_ofs r_ofs c_wth r_wth]',  ...
                            ',''ButtonDownFcn''       ,@obj.ana_time_btd_fcn', ...
                            ',''Tag''                 ,','''tag_',num2str(i),'_',num2str(j),'''', ...
        ...
        function bsg_but3_1_clb(obj,~,~)
            ...
            for l=show_vec
                ...
                tmp = [obj.dig_out_struct(l).timings_array.out]*Adwin.Default_parameters.t_res;
        ...
        function blk_edit_btd_fcn(obj,~,~)
            ...
            if ~isempty(obj.beg)&&ishandle(obj.beg.h)
                ...
                %t_res
                %set(obj.beg.txt4,'String',num2str(obj.dig_out_struct(i).timings_array(j).out));
                set(obj.beg.txt4,'String',num2str(obj.dig_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res));
                
                if ~isequal(obj.dig_out_struct(i).timings_array(j).out,Inf)
                    
                    %t_res
                    %set(obj.beg.txt6,'String',num2str(uint32(obj.dig_out_struct(i).timings_array(j).out/Adwin.Default_parameters.t_res)));
...
%                     );
        ...
        function ana_time_btd_fcn(obj,~,~)
            ...
            if ~isempty(obj.aeg)&&ishandle(obj.aeg.h)
                ...
                %t_res
                %set(obj.aeg.txt4,'String',num2str(obj.ana_out_struct(i).timings_array(j).out));
                set(obj.aeg.txt4,'String',num2str(obj.ana_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res));
                
                if ~isequal(obj.ana_out_struct(i).timings_array(j).out,Inf)
                    
                    %t_res
                    %set(obj.aeg.txt6,'String',num2str(uint32(obj.ana_out_struct(i).timings_array(j).out/Adwin.Default_parameters.t_res)));
...
%                     );
        ...
        function aeg_edt1_clb(obj,~,~)
            ...
            %t_res
            %eval(['set(obj.asg.text3',num2str(i),'_',num2str(j),',''String'',num2str(obj.ana_out_struct(i).timings_array(j).out)',');']);
            eval(['set(obj.asg.text3',num2str(i),'_',num2str(j),',''String'',num2str(obj.ana_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res)',');']);
...
%                     ');']);
        ...
        function beg_edt1_clb(obj,~,~)
            ...
            %t_res
            %eval(['set(obj.bsg.text',num2str(i),'_',num2str(j),',''String'',num2str(obj.dig_out_struct(i).timings_array(j).out)',');']);
            eval(['set(obj.bsg.text',num2str(i),'_',num2str(j),',''String'',num2str(obj.dig_out_struct(i).timings_array(j).out*Adwin.Default_parameters.t_res)',');']);
