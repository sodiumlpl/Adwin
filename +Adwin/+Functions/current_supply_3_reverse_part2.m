function val = current_supply_3_reverse(t)

load C:\Users\BEC\Documents\MATLAB\13_Adwin\sequence_manager\+Adwin\+Functions\current_supply_3_part2.mat
...
% 
% val = MagTrap_current/MagTrap_ref*ppval(pp3,y_pos(1-t));
% 
% clear pp3 ypos
